...
// import RecomModal from "./Recommendation";
        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell>Similar Stocks</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {purchasedStocks.map((row) => {
              ...
              return (
                <TableRow key={row.id}>
                  ...
                  {/* <TableCell>
                  <Link onClick={() => openRecomModal(row)}>Recommendations</Link>
                  </TableCell> */}
                  <TableCell>{"1) " + row.rec1 +", 2) "+ row.rec2 +", 3) "+ row.rec3 || "----"}</TableCell>
                </TableRow>
              );
            })}
          </TableBody>
