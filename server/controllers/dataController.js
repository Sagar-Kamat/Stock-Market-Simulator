...
const TIINGO_API_KEY = require('../config/keys');

exports.getStockMetaData = async (req, res) => {
  try {
    const url = `https://api.tiingo.com/tiingo/daily/${req.params.ticker}?token=520c8c82d2c1f3914f14a7b66668541cb4025836`;
...
exports.getStockHistoricData = async (req, res) => {
  try {
    ...
    const url = `https://api.tiingo.com/tiingo/daily/${req.params.ticker}/prices?startDate=${year}-${month}-${day}&token=520c8c82d2c1f3914f14a7b66668541cb4025836`;
...
exports.getRandomStockData = async (req, res) => {
  try {
    ...
    const url = `https://api.tiingo.com/tiingo/daily/${stock.ticker}/prices?startDate=${year}-${month}-${day}&token=520c8c82d2c1f3914f14a7b66668541cb4025836`;
